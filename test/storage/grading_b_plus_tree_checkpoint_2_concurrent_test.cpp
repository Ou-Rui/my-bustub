...
//          .Running main() from gmock_main.cc[== == == == == ] Running 7 tests from 1 test suite.[----------] Global
//          test
//                              environment set -
...
//
//  // helper function to delete
//  void DeleteHelper(BPlusTree<GenericKey<8>, RID, GenericComparator<8>> * tree, const std::vector<int64_t>
//  &remove_keys,
//                    uint64_t tid, __attribute__((unused)) uint64_t thread_itr = 0) {
//    GenericKey<8> index_key;
//    // create transaction
